...
/// codeforces problem link -> https://codeforces.com/contest/86/problem/D
...
int32_t main()
{
    ...
    for(int i = 0; i < Q; i++) {
        scanf("%lld %lld", &queries[i].first.first, &queries[i].first.second);
        queries[i].second = i;
